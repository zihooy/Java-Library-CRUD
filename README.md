...
- Naver Search API 사용
    - Naver Search API를 통해 검색한 도서의 정보를 가져와 바로 DB에 Insert
       ...
       [검색 > 책 - Search API](https://developers.naver.com/docs/serviceapi/search/book/book.md)
...
- 교보문고 UI를 참고하여 디자인
       ...
       [서비스 점검 - 교보문고](https://product.kyobobook.co.kr/bestseller/online?period=001#?page=1&per=20&ymw=&period=001&saleCmdtClstCode=&dsplDvsnCode=000&dsplTrgtDvsnCode=001&saleCmdtDsplDvsnCode=)
